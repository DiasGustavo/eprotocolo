...
public class DocumentoBean {
	...
	public void showMessage() {
        ...
        if(docCadastro.getStatus().equals("requerimentoCD")){ 
        	FacesUtil.addMsgInfo("Documentos necessários \n Pessoa Física \n Do contribuinte:	\n Cópias do RG e CPF."
		...
		/*FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "What we do in life", "Documentos necessários \n Pessoa Física \n Do contribuinte:	\n Cópias do RG e CPF."
        			+ "\n Do Procurador, no caso de requerimento feito mediante procuração: \n"
        			+ "Procuração particular; \n"
        			+ "Cópias do RG e CPF."
        			+ "Pessoa Jurídica: \n Do contribuinte: \n Cópia do Cartão de CNPJ;"
	...
	public void mostrar(){
		...
		switch (opc){
			case "requerimentoCD":
				this.exibirCD = true;
				this.exibirIT = false;
				FacesUtil.addMsgInfo("Documentos necessários <br/> Pessoa Física <br/>"
						+ "-<u>Do contribuinte:</u>	<br/> * Cópias do RG e CPF."
	        			+ "<br/>- Do Procurador, no caso de requerimento feito mediante procuração: <br/>"
	        			+ "* Procuração particular; <br/>"
	        			+ "* Cópias do RG e CPF. <br/>"
	        			+ "Pessoa Jurídica: <br/> -<u>Do contribuinte:</u> <br/> "
	        			+ "*Cópia do Cartão de CNPJ;"
	        			+ "<br/> -<u>Gerente/responsável</u>"
	        			+ "<br/> * Cópias do RG e CPF. <br/>"
	        			+ "-<u>Do procurador, no caso de requerimento feito mediante procuração:</u> <br/>"
	        			+ "* Procuração particular; <br/>"
	        			+ "* Cópias do RG e CPF.");
				break;
			case "requerimentoI":
				this.exibirIT = true;
				this.exibirCD = false;
				FacesUtil.addMsgInfo("<p style='color:red'>Documentos necessários</p> <br/> Pessoa Física <br/>"
						+ "-<u>Do contribuinte:</u>	<br/> * Cópias do RG e CPF."
	        			+ "<br/>- Do Procurador, no caso de requerimento feito mediante procuração: <br/>"
	        			+ "* Procuração particular; <br/>"
	        			+ "* Cópias do RG e CPF. <br/>"
